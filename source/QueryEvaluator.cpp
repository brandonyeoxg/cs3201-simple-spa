...
bool QueryEvaluator::getRelationResultFromPkb(Relation t_relation) {
  ...
  if (t_relation.getType() == queryType::RType::FOLLOWS) {
    if (t_relation.getG1().getType() == queryType::GType::STMT_NO && t_relation.getG2().getType() == queryType::GType::STMT_NO) {
    ...
    } else if (t_relation.getG1().getType() == queryType::GType::STMT_NO && (t_relation.getG2().getType() == queryType::GType::STMT || t_relation.getG2().getType() == queryType::GType::ASGN || t_relation.getG2().getType() == queryType::GType::WHILE || t_relation.getG2().getType() == queryType::GType::PROG_LINE)) {
      int stmtNo;
      try {
      ...
      if (t_relation.getG2().getType() == queryType::GType::STMT || t_relation.getG2().getType() == queryType::GType::PROG_LINE) {
        if (typeOfStmts[stmtNo] == queryType::GType::STMT || typeOfStmts[stmtNo] == queryType::GType::ASGN || typeOfStmts[stmtNo] == queryType::GType::WHILE || typeOfStmts[stmtNo] == queryType::GType::PROG_LINE) {
          stmtVector.push_back(std::to_string(stmtNo));
        }
      } else if (t_relation.getG2().getType() == queryType::GType::ASGN || t_relation.getG2().getType() == queryType::GType::WHILE) {
    ...
    } else if ((t_relation.getG1().getType() == queryType::GType::STMT || t_relation.getG1().getType() == queryType::GType::ASGN || t_relation.getG1().getType() == queryType::GType::WHILE || t_relation.getG1().getType() == queryType::GType::PROG_LINE) && t_relation.getG2().getType() == queryType::GType::STMT_NO) {
      int stmtNo;
      try {
      ...
      if (t_relation.getG1().getType() == queryType::GType::STMT || t_relation.getG1().getType() == queryType::GType::PROG_LINE) {
        if (typeOfStmts[stmtNo] == queryType::GType::STMT || typeOfStmts[stmtNo] == queryType::GType::ASGN || typeOfStmts[stmtNo] == queryType::GType::WHILE || typeOfStmts[stmtNo] == queryType::GType::PROG_LINE) {
          stmtVector.push_back(std::to_string(stmtNo));
        }
      } else if (t_relation.getG1().getType() == queryType::GType::ASGN || t_relation.getG1().getType() == queryType::GType::WHILE) {
    ...
    } else if ((t_relation.getG1().getType() == queryType::GType::STMT || t_relation.getG1().getType() == queryType::GType::ASGN || t_relation.getG1().getType() == queryType::GType::WHILE || t_relation.getG1().getType() == queryType::GType::PROG_LINE) && (t_relation.getG2().getType() == queryType::GType::STMT || t_relation.getG2().getType() == queryType::GType::ASGN || t_relation.getG2().getType() == queryType::GType::WHILE || t_relation.getG2().getType() == queryType::GType::PROG_LINE)) {
      ...
      for (auto& x : allFollows) {
        std::vector<std::string> stmtVector;
        if (t_relation.getG2().getType() == queryType::GType::STMT || t_relation.getG2().getType() == queryType::GType::PROG_LINE) {
          if (typeOfStmts[x.second] == queryType::GType::STMT || typeOfStmts[x.second] == queryType::GType::ASGN || typeOfStmts[x.second] == queryType::GType::WHILE || typeOfStmts[x.second] == queryType::GType::PROG_LINE) {
        ...
        if (t_relation.getG1().getType() == queryType::GType::STMT || t_relation.getG1().getType() == queryType::GType::PROG_LINE) {
          if (typeOfStmts[x.first] == queryType::GType::STMT || typeOfStmts[x.first] == queryType::GType::ASGN || typeOfStmts[x.first] == queryType::GType::WHILE || typeOfStmts[x.first] == queryType::GType::PROG_LINE) {
      ...
      if (t_relation.getG1().getType() == queryType::GType::STMT_NO) {
      ...
      } else if (t_relation.getG1().getType() == queryType::GType::STMT || t_relation.getG1().getType() == queryType::GType::ASGN || t_relation.getG1().getType() == queryType::GType::WHILE || t_relation.getG1().getType() == queryType::GType::PROG_LINE) {
        ...
        for (auto& x : stmtIntVector) {
          if (t_relation.getG1().getType() == queryType::GType::STMT || t_relation.getG1().getType() == queryType::GType::PROG_LINE) {
            if (typeOfStmts[x] == queryType::GType::STMT || typeOfStmts[x] == queryType::GType::ASGN || typeOfStmts[x] == queryType::GType::WHILE || typeOfStmts[x] == queryType::GType::PROG_LINE) {
      ...
      if (t_relation.getG2().getType() == queryType::GType::STMT_NO) {
      ...
      } else if (t_relation.getG2().getType() == queryType::GType::STMT || t_relation.getG2().getType() == queryType::GType::ASGN || t_relation.getG2().getType() == queryType::GType::WHILE || t_relation.getG2().getType() == queryType::GType::PROG_LINE) {
  ...
  } else if (t_relation.getType() == queryType::RType::FOLLOWS_) {
    ...
    if (t_relation.getG1().getType() == queryType::GType::STMT_NO && t_relation.getG2().getType() == queryType::GType::STMT_NO) {
      ...
      for (auto& x : allFollows) {
        ...
        for (auto& y : x.second) {
          if (t_relation.getG2().getType() == queryType::GType::STMT || t_relation.getG2().getType() == queryType::GType::PROG_LINE) {
            if (typeOfStmts[y] == queryType::GType::STMT || typeOfStmts[y] == queryType::GType::ASGN || typeOfStmts[y] == queryType::GType::WHILE || typeOfStmts[y] == queryType::GType::PROG_LINE) {
  ...
  } else if (t_relation.getType() == queryType::RType::PARENT) {
    if (t_relation.getG1().getType() == queryType::GType::STMT_NO && t_relation.getG2().getType() == queryType::GType::STMT_NO) {
      ...
      result[t_relation.getG2().getName()] = stmtStrVector;
    } else if ((t_relation.getG1().getType() == queryType::GType::STMT || t_relation.getG1().getType() == queryType::GType::WHILE || t_relation.getG1().getType() == queryType::GType::PROG_LINE) && t_relation.getG2().getType() == queryType::GType::STMT_NO) {
      int stmtNo;
      try {
      ...
      result[t_relation.getG1().getName()] = stmtVector;
    } else if ((t_relation.getG1().getType() == queryType::GType::STMT || t_relation.getG1().getType() == queryType::GType::WHILE || t_relation.getG1().getType() == queryType::GType::PROG_LINE) && (t_relation.getG2().getType() == queryType::GType::STMT || t_relation.getG2().getType() == queryType::GType::ASGN || t_relation.getG2().getType() == queryType::GType::WHILE || t_relation.getG2().getType() == queryType::GType::PROG_LINE)) {
      ...
      } else if (t_relation.getG1().getType() == queryType::GType::STMT || t_relation.getG1().getType() == queryType::GType::WHILE || t_relation.getG1().getType() == queryType::GType::PROG_LINE) {
  ...
  } else if (t_relation.getType() == queryType::RType::PARENT_) {
    if (t_relation.getG1().getType() == queryType::GType::STMT_NO && t_relation.getG2().getType() == queryType::GType::STMT_NO) {
  ...
  } else if (t_relation.getType() == queryType::RType::USES) {
    if (t_relation.getG1().getType() == queryType::GType::STMT_NO && t_relation.getG2().getName() != "_" && t_relation.getG2().getType() == queryType::GType::STR) {
    ...
    } else if (t_relation.getG1().getType() == queryType::GType::STMT_NO && t_relation.getG2().getType() == queryType::GType::VAR) {
    ...
    } else if ((t_relation.getG1().getType() == queryType::GType::STMT || t_relation.getG1().getType() == queryType::GType::ASGN || t_relation.getG1().getType() == queryType::GType::WHILE || t_relation.getG1().getType() == queryType::GType::PROG_LINE) && t_relation.getG2().getName() != "_" && t_relation.getG2().getType() == queryType::GType::STR) {
      ...
      result[t_relation.getG1().getName()] = stmtStrVector;
    } else if ((t_relation.getG1().getType() == queryType::GType::STMT || t_relation.getG1().getType() == queryType::GType::ASGN || t_relation.getG1().getType() == queryType::GType::WHILE || t_relation.getG1().getType() == queryType::GType::PROG_LINE) && t_relation.getG2().getType() == queryType::GType::VAR) {
  ...
  } else if (t_relation.getType() == queryType::RType::MODIFIES) {
    if (t_relation.getG1().getType() == queryType::GType::STMT_NO && t_relation.getG2().getName() != "_" && t_relation.getG2().getType() == queryType::GType::STR) {
