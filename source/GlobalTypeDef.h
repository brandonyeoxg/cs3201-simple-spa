...
typedef std::unordered_map<VAR_INDEX, SET_OF_STMT_NUMS> MAP_OF_VAR_INDEX_TO_SET_OF_NUMS;
...
typedef std::unordered_map<VAR_INDEX, SET_OF_STMT_NUMS> MAP_OF_VAR_INDEX_TO_SET_OF_STMT_NUMS;
