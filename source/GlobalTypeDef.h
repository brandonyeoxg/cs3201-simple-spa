...
typedef std::vector<INTEGER> LIST_OF_RESULTS_INDICES;
...
typedef std::unordered_map<int, std::vector<int>> SET_OF_RESULTS_INDICES;
...
typedef std::vector<std::vector<int>> INTERMEDIATE_TABLE;
